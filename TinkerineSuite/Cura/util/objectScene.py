...
class Scene(object):
	...
	def getMinMaxPosition(self):
		...
		for obj in self._objectList:
			pos = obj.getPosition()
			#print pos
			x1 = obj.getPosition()[0] + obj.getSize()[0] /2
			x2 = obj.getPosition()[0] - obj.getSize()[0] /2
			y1 = obj.getPosition()[1] + obj.getSize()[1] /2
			y2 = obj.getPosition()[1] - obj.getSize()[1] /2
			#print [x,y]
			if x1 > maxX: 
				maxX = x1
			if x1 < minX:
