...
class CarveSkein(object):
	...
	def getCarvedSVG(self, carving, fileName, repository):
		...
		repository.numLayers = len(loopLayers)
		...
		svgWriter = svg_writer.SVGWriter(
			...
			edgeWidth)
		numTopLayers = 3
		truncatedRotatedBoundaryLayers = svg_writer.getTruncatedRotatedBoundaryLayers(loopLayers, repository, numTopLayers,len(loopLayers))
