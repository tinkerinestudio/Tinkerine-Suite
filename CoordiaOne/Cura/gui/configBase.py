...
class TitleRow():
	def __init__(self, panel, name):
		...
		sizer.Add(self.title, (x,0), (1,6), flag=wx.EXPAND|wx.TOP|wx.LEFT, border=10)
		
		self.ln = wx.StaticLine(panel, -1)

		sizer.Add(self.ln, (x+1,0), (1,3), flag=wx.EXPAND|wx.LEFT,border=10)
		sizer.SetRows(x + 2)
	def HideSelf(self):
		self.title.Hide()
		self.ln.Hide()
...
class SettingRow():
	...
	def HideSelf(self):
		self.label.Hide()
		self.ctrl.Hide()
		#self.label.Parent.FitInside() 
		#self.label.Parent.Refresh() 
	def ShowSelf(self):
		self.label.Show()
		self.ctrl.Show()
