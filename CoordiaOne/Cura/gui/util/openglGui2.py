...
class glGuiPanel(glcanvas.GLCanvas):
	...
	def _drawGui(self):
		...
		#testTooltip = tooltipText.tooltipText(20, 130, "CAMERA VIEW", "HelveticaNeueLTStd-Lt.otf", 24, (139,197,63)) #(43,182,115)
	...
	def draw(self):
		...
		if self._focus:
			...
			if 1: #removed image for hover over
				...
				glBindTexture(GL_TEXTURE_2D, opengl.loadGLTexture2(self._tooltipTextTitle._pBits))
				self._tooltipTextTitle.displayText2()

				glBindTexture(GL_TEXTURE_2D, opengl.loadGLTexture2(self._tooltipText._pBits))
