...
class mainWindow(wx.Frame):
	def __init__(self):
		super(mainWindow, self).__init__(None, title='Coordia One - ' + version.getVersion())
		...
		i = helpMenu.Append(-1, 'About Coordia')
	...
	def OnAbout(self, e):
		...
		info.SetName('Coordia')
		info.SetDescription('Plating, Preparing and Slicing for Fused Filament Fabrication 3D printing.')
		info.SetWebSite('http://www.tinkerines.com/coordia')
		info.SetCopyright('Copyright (C) Tinkerine Studio')
		info.SetLicence("""
