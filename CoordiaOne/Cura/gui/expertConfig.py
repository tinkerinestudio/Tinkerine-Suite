...
class expertConfigWindow(wx.Frame):
	...
	def __init__(self, parent):
		...
		c = configBase.SettingRow(left, "Travel Speed (mm/s) ", 'travel_speed', '400', 'How fast the extruder moves while not printing.')
		self.configList.append(c)
		...
		c = configBase.SettingRow(right, "Infill in direction of bridge", 'bridge_direction', False, 'If this is on, infill will fill in the direction of bridging. This improves bridging but may increase print time.')
		self.configList.append(c)
